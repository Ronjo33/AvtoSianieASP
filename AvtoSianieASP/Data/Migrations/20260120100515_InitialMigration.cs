        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    KatNum = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DescSurves = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Serveces_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServeceId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_Serveces_ServeceId",
                        column: x => x.ServeceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_ServeceId",
                table: "Orders",
                column: "ServeceId");

            migrationBuilder.CreateIndex(
                name: "IX_Serveces_CategoryId",
                table: "Serveces",
                column: "CategoryId");
        }
